"""
Vista operacional de pedidos.

Contenido movido tal cual desde `dashboard/app.py` cuando app.py pasó a ser
el punto de entrada con `st.navigation()`. Los únicos cambios respecto al
original son el `st.set_page_config()` (que solo puede vivir en el entry
point) y el breadcrumb de la identidad visual — la lógica de negocio, los
filtros, los KPIs y los drill-downs quedaron intactos.
"""
