...
from db import get_operacion_ciclos, get_operacion_ventanas
...
tab_capacidad, tab_ciclos, tab_carga = st.tabs(
    ["Capacidad del equipo", "Tiempos de ciclo", "Carga por persona"]
)
